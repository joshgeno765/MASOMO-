...
const northAmerica: Country[] = [
  {
    ...
    schools: [
      { name: 'BCIT — British Columbia Institute of Technology', type: 'Public Polytechnic Institute', city: 'Burnaby, BC', photo: '/images/schools/bcit.jpg', website: 'https://www.bcit.ca' },
      { name: 'TRU — Thompson Rivers University', type: 'Public University', city: 'Kamloops, BC', photo: '/images/schools/tru.jpg', website: 'https://www.tru.ca' },
      { name: 'University of Lethbridge', type: 'Public University', city: 'Lethbridge, AB', photo: '/images/schools/lethbridge.jpg', website: 'https://www.ulethbridge.ca' },
      { name: 'Northern Lights College', type: 'Public College', city: 'Dawson Creek, BC', photo: null, website: 'https://www.nlc.bc.ca' },
      { name: 'North Island College', type: 'Public College', city: 'Comox Valley, BC', photo: null, website: 'https://www.nic.bc.ca' },
    ],
